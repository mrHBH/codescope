...
| **Text input outside DOM** — freeform text editing without contenteditable | High | The code editor already solves this for monospace; the terminal solves it for single-line input. General text fields need IME integration which is DOM-dependent. Defer to Phase 5+. |
